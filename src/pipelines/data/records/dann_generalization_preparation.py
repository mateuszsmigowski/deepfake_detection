...
class DannGeneralizationRecordsPreparation(RecordsPreparation):
    ...
    def prepare(self):
        ...
        self._log_split_counts(train_records, "train", tag="dann_generalization", extra=f"per_domain: {train_per_domain}")
        self._log_split_counts(val_records, "val", tag="dann_generalization", extra=f"per_domain: {val_per_domain}")
